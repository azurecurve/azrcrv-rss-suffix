...
Download link:	https://github.com/azurecurve/azrcrv-rss-suffix/releases/download/v1.2.1/azrcrv-rss-suffix.zip
 ...
 * Download the plugin from [GitHub](https://github.com/azurecurve/azrcrv-rss-suffix/releases/latest/).

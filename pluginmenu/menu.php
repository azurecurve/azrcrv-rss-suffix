 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_rsss')){
	function azrcrv_create_plugin_menu_rsss(){
		azrcrv_create_plugin_menu_table_rsss();
		azrcrv_populate_plugin_menu_table_rsss();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_rsss')){
	function azrcrv_populate_plugin_menu_table_rsss(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_rsss')){
	function azrcrv_create_plugin_menu_table_rsss(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
